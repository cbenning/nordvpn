...
function setupnordvpn() {
	...
	[[ -n ${NORDVPN_CYBERSEC} ]] && nordvpn set cybersec ${NORDVPN_CYBERSEC}
	[[ -n ${NORDVPN_OBFUSCATE} ]] && nordvpn set obfuscate ${NORDVPN_OBFUSCATE}
...
trap cleanup EXIT # https://www.ctl.io/developers/blog/post/gracefully-stopping-docker-containers/
